...
import me.hletrd.telecampro.camera.DEFAULT_PHONE_MODEL
import me.hletrd.telecampro.camera.DEFAULT_TELECONVERTER_PROFILE
...
import me.hletrd.telecampro.camera.WbGains
 ...
 * Defaults mirror [me.hletrd.telecampro.camera.CameraUiState] so a missing key restores the same
