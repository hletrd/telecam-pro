package me.hletrd.telecampro.ui.theme
...
object CameraColors {
     ...
     *
     * It has exactly ONE consumer — [me.hletrd.telecampro.ui.overlays.HudPlate], which bakes in
     * [me.hletrd.telecampro.ui.overlays.HUD_TEXT_SCRIM_ALPHA]. Do NOT reference this token at a draw
     ...
     * They now paint [me.hletrd.telecampro.ui.overlays.HudPlate] like every other HUD plate. Keep this
     ...
     *
     * It is NOT [me.hletrd.telecampro.ui.overlays.HudPlate]: that is a translucent BLACK slab whose
 ...
 */
@Composable
fun TeleCamProTheme(content: @Composable () -> Unit) {
    MaterialTheme(
