 ...
 * The UI renders [me.hletrd.findx9tele.camera.CameraUiState] and calls these — it never touches
 * Camera2/GL directly.
 */
interface CameraActions {
    ...
    // Stabilization
    fun onVideoStabMode(mode: me.hletrd.findx9tele.camera.VideoStabMode)
    ...
    fun onZebraLevel(level: me.hletrd.findx9tele.camera.ZebraLevel)
    ...
    fun onLens(choice: me.hletrd.findx9tele.camera.LensChoice)
