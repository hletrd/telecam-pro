 ...
 * fully JVM-unit-testable (the same discipline as [me.hletrd.findx9tele.focus.FocusMapping]).
 *
...
object RotationMath {
     ...
     * ([me.hletrd.findx9tele.gl.FrontMirrorConvention] decides which draws mirror; rotation never
