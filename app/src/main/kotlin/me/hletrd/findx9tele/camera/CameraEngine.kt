...
import me.hletrd.findx9tele.capture.DngCapture
import me.hletrd.findx9tele.capture.ExifShot
import me.hletrd.findx9tele.capture.ShotSpec
import me.hletrd.findx9tele.capture.StillCapturePipeline
import me.hletrd.findx9tele.capture.HeifCapture
import me.hletrd.findx9tele.capture.StillSnapshot
import me.hletrd.findx9tele.gl.AtomicOwnerSlot
import me.hletrd.findx9tele.gl.EncoderOutputAdmission
import me.hletrd.findx9tele.gl.GlPipeline
import me.hletrd.findx9tele.gl.GlStopOutcome
import me.hletrd.findx9tele.gl.glInputTransactionMayProceed
import me.hletrd.findx9tele.gl.glReplacementMayRestartPreview
...
import me.hletrd.findx9tele.storage.RecoveryReport
import me.hletrd.findx9tele.storage.RecoveryRetryDecision
import me.hletrd.findx9tele.storage.recoveryRetryDecision
import me.hletrd.findx9tele.video.NativeGraphDisposition
import me.hletrd.findx9tele.video.UnsafeRecorderQuarantine
import me.hletrd.findx9tele.video.VideoRecorder
...
class CameraEngine(private val context: Context) {
    ...
    fun closerFocusingLensLabel(active: CameraCaps): String? {
        ...
        val hint = me.hletrd.findx9tele.focus.closerLensHint(
        ...
        return me.hletrd.findx9tele.focus.lensLabelForEquivFocal(hint.equivalentFocalMm)
    }
    ...
    private fun wireController(ownedGl: GlPipeline): CameraController {
        ...
        if (me.hletrd.findx9tele.BuildConfig.DEBUG && zslSpikeLoggingWanted) ctrl.setZslSpike(true)
        return ctrl
    }
    ...
    fun setTapPoint(nx: Float, ny: Float): Boolean = synchronized(this) {
        ...
        val geometry = mapTapFocusGeometry(
            ...
            mirrorX = me.hletrd.findx9tele.gl.FrontMirrorConvention.tapDisplayMirrorX(
    ...
    private fun startRecordingClaimed(
        ...
        processAdmission: me.hletrd.findx9tele.video.UnsafeRecorderAdmissionToken,
    ): Boolean {
