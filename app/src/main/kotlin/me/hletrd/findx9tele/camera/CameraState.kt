 ...
 * bakes the industry-standard curve + gamut matrix — see [me.hletrd.findx9tele.gl.LogProfiles]);
 ...
 * SDR-class transfer (see [me.hletrd.findx9tele.video.hevcColorTagsFor]). Like the old option,
 ...
 * app-side gyro-EIS mode was dropped — unusable at 300 mm; [me.hletrd.findx9tele.stab.GyroEis]
 ...
 * (see [me.hletrd.findx9tele.video.EncoderCaps]).
 */
