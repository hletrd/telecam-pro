...
class GlPipeline {
    ...
    private var finderRectCache: me.hletrd.findx9tele.camera.FinderRect? = null

    private fun finderRectFor(w: Float, h: Float): me.hletrd.findx9tele.camera.FinderRect {
