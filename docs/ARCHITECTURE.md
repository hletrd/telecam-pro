...
publication registers with the same exact-family authority before its
marker decision and keeps that authority through provider visibility plus the saved callback. Thus a
...
publication also prevents an absence proof from retiring its marker in front of it. Only short
