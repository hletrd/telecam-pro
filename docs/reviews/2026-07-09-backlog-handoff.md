...
> **Archived snapshot (2026-07-09).** This pre-release handoff preserves investigation history and
> may describe work that is now complete or behavior that was later replaced. Use `docs/BACKLOG.md`,
> `CLAUDE.md`, and `docs/ARCHITECTURE.md` for current status.
